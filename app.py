...
from resources.emp import Profile,Clubdelete,Clubnames,Mail,Changepasswordstudent,Editprofile,Studentlogin,Displaypostevents,Login,Adminlog,Requesttoclub,Clubmembers,Addclub,Forgotpassword,Allclubdetails,Changepassword,Addclubmembers
...
api.add_resource(Changepasswordstudent,'/changepasswordstudent')
